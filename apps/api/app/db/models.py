...
class WorkflowRunModel(Base):
    ...
    parent_workflow_run_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("workflow_runs.id", ondelete="SET NULL"), nullable=True)
    rerun_reason: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    rerun_shot_ids_jsonb: Mapped[Optional[list]] = mapped_column(JSONB, nullable=True)
