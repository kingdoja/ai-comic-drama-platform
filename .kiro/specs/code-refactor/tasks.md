...
- [x] 2. 移动和重组 Agent 文件
  ...
  - [x] 2.1 移动 base_agent.py 到 agents/

    - 移动文件
    - 更新 agents/__init__.py 导出
    - _Requirements: 1.2, 2.2_
  
  - [x] 2.2 移动所有 Agent 实现到 agents/
