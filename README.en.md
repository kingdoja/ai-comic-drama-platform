...
- **Interview Prep**: `docs/interview/` - Architecture explanations, technical talking points
- **Feature Specs**: `.kiro/specs/` - Detailed feature requirements and design documents

## 🤝 Interview Discussion Points

### Architecture & Design
- Why workflow-first instead of agent-first?
- How does the system prevent content drift?
- What are the tradeoffs of artifact-first state management?
- How would you scale this to handle 1000 concurrent workflows?

### Implementation Details
- How does the agent pipeline ensure consistency?
- What's the retry strategy and why?
- How are locked fields implemented and enforced?
- How does document versioning work?

### Testing & Quality
- Why property-based testing for this domain?
- How do you test AI agent outputs?
- What's your approach to integration testing?
- How do you ensure test reliability?

### Future Improvements
- How would you add real-time collaboration?
- What's the strategy for A/B testing different prompts?
- How would you implement workflow branching?
